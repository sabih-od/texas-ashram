...
function Events(props) {
    ...
    return (
        <Layout>
            ...
            <p style={{textAlign: 'left', color:'black'}}>On the first Saturday of every month, a group of people join a Zoom meeting for a brief Bible Study/Prayer Request meeting. We would love you to join. If you are not getting the email notifications about this meeting, please submit a “Contact Us” request so we can add you to our notifications. </p>
            ...
            <p style={{textAlign: 'left', color:'black'}}>The Texas Christian Ashram (TCA) is in the heart of beautiful East Texas at Scottsville Camp and Conference Center. Located near Marshall, TX, just 30 minutes from the Louisiana board, makes this campsite the perfect location for both Texas and Louisiana residents. TCA offers activities and dedicated programs for all ages. The youth enjoy worship and the Word of God while playing elaborate games that couple both competition and fun for everyone. The college and career program integrates with both the adult and youth programs at different times in order to meet the needs of the age group. The adult program incorporates teaching, worship, small group activities, and rest. The goal of TCA is to focus on Jesus and each other. Unique to TCA is the Blue Bell ice cream social each night where games are played, and ice cream is eaten.  </p>
