        ...
        n.extend(b.prototype, {
            ...
            createSlide: function (t) {
                ...
                return (
                    ...
                    !i.slides[t] && i.group[o] && ((e = n('<div class="fancybox-slide"></div>').appendTo(i.$refs.stage)), (i.slides[t] = n.extend(!0, {}, i.group[o], {
                        pos: t,
                        $slide: e,
                        isLoaded: !1
            ...
            canPan: function (t, e) {
                ...
                return (
                    ...
                    (i.isComplete || (t && e)) &&
                    !i.hasError &&
                    ((s = o.getFitPos(i)), void 0 !== t && void 0 !== e ? (a = {
                        width: t,
                        height: e
            ...
            adjustCaption: function (t) {
                ...
                i &&
                i.length &&
                (o.pos !== n.currPos ? ((e = s.clone().appendTo(s.parent())), e.children().eq(0).empty().html(i), (r = e.outerHeight(!0)), e.empty().remove()) : n.$caption && (r = n.$caption.outerHeight(!0)), o.$slide.css('padding-bottom', r || ''));
            },
    ...
    (function (t, e, n) {
        ...
        (n.escapeSelector = function (t) {
            return (t + '').replace(/([\0-\x1f\x7f]|^-?\d)|^-$|[^\x80-\uFFFF\w-]/g, function (t, e) {
                return e ? ('\0' === t ? 'ÃƒÆ’Ã‚Â¯Ãƒâ€šÃ‚Â¿Ãƒâ€šÃ‚Â½' : t.slice(0, -1) + '\\' + t.charCodeAt(t.length - 1).toString(16) + ' ') : '\\' + t;
            });
        }),
            n(function () {
    ...
    var S = {
        ...
        updateSlides: function () {
            ...
            'string' == typeof x && x.indexOf('%') >= 0 && (x = (parseFloat(x.replace('%', '')) / 100) * r),
                (e.virtualSize = -x),
                n ? c.css({marginLeft: '', marginBottom: '', marginTop: ''}) : c.css({
                    marginRight: '',
                    marginBottom: '',
                    marginTop: ''
                }),
